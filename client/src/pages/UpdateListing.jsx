...
export default function CreateListing() {
    ...
    // Initialise a variable to use the useParams for passing the listing information
    ...
    useEffect(() => {
        // Define a async function and use it within the uesEffect hook
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex flex-col flex-1 gap-3">
                ...
                <button className="p-3 bg-green-700 text-white rounded-lg hover:opacity-90 disabled:opacity-80"
                        ...
                        { submitLoading ? "Updating" : "Update Listing!"}</button>
